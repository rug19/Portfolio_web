  ...
  return (
    <section >
      <div>
        ...
        <p className="dark:text-white text-slate tracking-tight font-sans text-center lg:text-justify md:max-w-[600px] lg:max-w-[500px] 2xl:max-w-[600px] 2xl:text-lg">
          Here is a summary of my educational background, including academic
          degrees, online courses, and certifications.
        </p>
      </div>
      {/* Container */}
      <div className=" flex flex-col max-h-96 sm:max-h-72 max-h-65 w-full md:w-[600px] lg:w-[500px] 2xl:w-[600px] overflow-auto scrollbar-thin scrollbar-thumb-green scrollbar-track-transparent pt-2 lg:pt-0 sm:grid sm:grid-cols-2 gap-5 lg:gap-4 mt-4 mb-9 sm:mb-0 p-0 z-[5] ">
        {items.map((item) => (
          <article
