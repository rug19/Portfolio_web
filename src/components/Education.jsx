  ...
  return (
    <>
      <div>
        ...
        {/* Container */}
        <div className=" flex flex-col   sm:max-h-72 max-h-64  w-full overflow-auto scrollbar-thin scrollbar-thumb-green scrollbar-track-transparent pt-2 lg:pt-0 sm:grid sm:grid-cols-2 gap-5 lg:gap-4 mt-10 mb-10 sm:mb-0 p-0">
          {items.map((item) => (
            <div
