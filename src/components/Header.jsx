...
export default function Header() {
  ...
  return (
    <header className=" bg-black  lg:bg-black/0 md:flex  md:justify-between md:items-center  fixed top-0 left-0 w-full h-20 md:p-5 justify-between items-center p-5 lg:p-10">
